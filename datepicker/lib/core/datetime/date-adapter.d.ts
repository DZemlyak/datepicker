...
export declare type DateUnit = 'y' | 'year' | 'years' | 'M' | 'month' | 'months' | 'd' | 'day' | 'days' | 'h' | 'hour' | 'hours' | 'm' | 'minute' | 'minutes';
...
export declare abstract class DateAdapter<D> {
     ...
     */
    abstract createDate(year: number, month: number, date: number, hours?: number, minutes?: number, seconds?: number, ms?: number): D;
    /**
     * Gets today's date.
     ...
     */
    compareDate(first: D, second: D, unit?: DateUnit): number;
    /**
     ...
     */
    sameDate(first: D | null, second: D | null, unit?: DateUnit): boolean;
    /**
