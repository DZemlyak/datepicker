...
import { Directive, Component, ViewEncapsulation, ChangeDetectionStrategy, Input, HostBinding, Injectable, ɵstringify, ɵisObservable, Pipe, NgModule } from '@angular/core';
import * as i2 from '@angular/material/progress-spinner';
import { MatProgressSpinnerModule } from '@angular/material/progress-spinner';
import { Subject, isObservable, combineLatest, merge, of, BehaviorSubject, timer, pipe } from 'rxjs';
import { takeUntil, map, first, switchMap, startWith, scan, tap, take, filter, catchError, throttleTime, skipWhile, distinctUntilChanged } from 'rxjs/operators';
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DataSourceContent, [{
            type: Directive,
            args: [{
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DataSourceEmpty, [{
            type: Directive,
            args: [{
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DataSourceError, [{
            type: Directive,
            args: [{
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DataSourceLoading, [{
            type: Directive,
            args: [{
...
function DataSourceOverlay_ng_container_0_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementContainer(0);
    }
}
function DataSourceOverlay_ng_template_1_ng_container_4_mat_datasource_loading_1_Template(rf, ctx) {
    if (rf & 1) {
...
function DataSourceOverlay_ng_template_1_ng_container_4_Template(rf, ctx) {
    if (rf & 1) {
...
function DataSourceOverlay_ng_template_1_Template(rf, ctx) {
    if (rf & 1) {
...
function DataSourceOverlay_ng_template_3_ng_container_0_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementContainer(0);
    }
}
function DataSourceOverlay_ng_template_3_ng_template_1_ng_container_3_mat_datasource_error_1_Template(rf, ctx) {
    if (rf & 1) {
...
function DataSourceOverlay_ng_template_3_ng_template_1_ng_container_3_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementContainerStart(0);
...
function DataSourceOverlay_ng_template_3_ng_template_1_Template(rf, ctx) {
    if (rf & 1) {
...
function DataSourceOverlay_ng_template_3_ng_template_3_ng_container_3_Template(rf, ctx) {
    if (rf & 1) {
        i0.ɵɵelementContainerStart(0);
...
function DataSourceOverlay_ng_template_3_ng_template_3_Template(rf, ctx) {
    if (rf & 1) {
...
function DataSourceOverlay_ng_template_3_Template(rf, ctx) {
    if (rf & 1) {
...
DataSourceOverlay.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DataSourceOverlay, selectors: [["mat-datasource-overlay"]], hostAttrs: [1, "mat-datasource-overlay"], hostVars: 2, hostBindings: function DataSourceOverlay_HostBindings(rf, ctx) {
        if (rf & 2) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DataSourceOverlay, [{
            type: Component,
...
DataSourceContainer.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DataSourceContainer, selectors: [["mat-datasource"]], hostAttrs: [1, "mat-datasource"], inputs: { dataSource: "dataSource", diameter: "diameter", strokeWidth: "strokeWidth" }, ngContentSelectors: _c1, decls: 9, vars: 5, consts: [[1, "mat-datasource-container"], [1, "mat-datasource-output"], [3, "dataSource", "diameter", "strokeWidth"]], template: function DataSourceContainer_Template(rf, ctx) {
        if (rf & 1) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DataSourceContainer, [{
            type: Component,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MatDataSourceIntl, [{
            type: Injectable,
            args: [{
                    providedIn: 'root',
                }]
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(DataSourcePipe, [{
            type: Pipe,
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MatDataSourceModule, [{
            type: NgModule,
            args: [{
...
(function () {
    (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(MatDataSourceModule, { declarations: [DataSourceContainer,
            DataSourceContent,
            DataSourceEmpty,
            DataSourceError,
            DataSourceLoading,
...
class DataSourceLogger {
    ...
    getTimeoutError(attempt) {
        ...
        switch (attempt) {
            case 0:
                return ((_a = this._intl) === null || _a === void 0 ? void 0 : _a.waitMsg) || this._config.waitMsg;
            case 1:
                return ((_b = this._intl) === null || _b === void 0 ? void 0 : _b.delayMsg) || this._config.delayMsg;
            default:
                throw new Error(((_c = this._intl) === null || _c === void 0 ? void 0 : _c.timeoutMsg) || this._config.timeoutMsg);
        }
    }
    clearErrors() {
        this._errors = {};
...
class MatDataSource extends DataSource {
     ...
     */
    addArguments(args) {
        this.defaults = Object.assign(Object.assign({}, this.defaults), args);
    }
    addStream(stream) {
    ...
    _getArgs(output) {
        ...
        this.arguments = Object.assign(Object.assign(Object.assign({}, this.defaults), output), this.overrides);
    ...
    _emptyMessage() {
        var _a;
        if ((_a = this.intl) === null || _a === void 0 ? void 0 : _a.emptyMsg) {
...
(function () {
    (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MatDataSource, [{
            type: Injectable
