...
export declare type MatCalendarCellClassFunction<D> = (date: D, view: MatCalendarView) => MatCalendarCellCssClasses;
/**
...
export declare class MatCalendarBody implements OnChanges, OnDestroy {
    ...
    readonly previewChange: EventEmitter<MatCalendarUserEvent<MatCalendarCell<any>>>;
